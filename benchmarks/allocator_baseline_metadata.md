...
The current selected mimalloc-regression refresh measured Mnemosyne at `16.131 us` for threaded small allocation cycles, `89.323 us` for threaded saturated small allocation cycles, and `11.116 ns` for `usable size latency/small_32`.
