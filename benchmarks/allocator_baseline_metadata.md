...
The current selected mimalloc-regression refresh measured Mnemosyne at `11.877 us` for threaded small allocation cycles, `93.760 us` for threaded saturated small allocation cycles, `6.846 ns` for `usable size latency/small_32`, and `7.460 ns` for `realloc latency/within_class_24_to_32`. The refreshed variance report marks these Mnemosyne rows stable under their row-specific CI-width thresholds.
