...
| cross-thread free handoff/small_32 | 16830.944 | 30579.434 | 18156.715 | 20673.691 | 32499.430 | 0.55x | 0.93x | 0.81x | 0.52x |
| realloc latency/cross_class_32_to_64 | 7.092 | 43.361 | 7.559 | 32.864 | 17.032 | 0.16x | 0.94x | 0.22x | 0.42x |
| realloc latency/cross_class_8k_to_16k | 48.022 | 131.783 | 67.160 | 132.324 | 61.556 | 0.36x | 0.72x | 0.36x | 0.78x |
| realloc latency/huge_shrink_4m_to_2m | 74896.928 | 976030.415 | 6702.816 | 1039354.869 | 251.877 | 0.08x | 11.17x | 0.07x | 297.36x |
| realloc latency/within_class_24_to_32 | 3.348 | 43.437 | 4.410 | 17.131 | 22.998 | 0.08x | 0.76x | 0.20x | 0.15x |
| realloc latency/within_class_6k_to_8k | 24.555 | 103.021 | 56.375 | 93.840 | 53.091 | 0.24x | 0.44x | 0.26x | 0.46x |
