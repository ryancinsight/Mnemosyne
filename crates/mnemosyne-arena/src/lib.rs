...
pub use scratch::{AlignedVec, AlignedVecIntoIter, Drain, DEFAULT_SCRATCH_ALIGN, ScratchBank, ScratchElement, ScratchPool};
pub use segment::{
    ...
    deallocate_segment, purge_segment_pool, purge_segment_pool_with_warm, reset_segment_pool,
